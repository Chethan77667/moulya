#!/usr/bin/env python3
"""
Clean script to convert student names to uppercase
=================================================

This script converts all student names in the MongoDB collection to uppercase.
It's designed to work on all systems including Windows.

Usage:
    python scripts/convert_names_clean.py
"""
